...
/**
 * REST controller for managing {@link fr.clem.pizza.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Commande> partialUpdateCommande(
        ...
        Optional<Commande> result = commandeRepository
            ...
            .map(existingCommande -> {
                if (commande.getEstAEmporter() != null) {
                    existingCommande.setEstAEmporter(commande.getEstAEmporter());
                }
                if (commande.getDateHeureCreation() != null) {
                    existingCommande.setDateHeureCreation(commande.getDateHeureCreation());
                }
                if (commande.getDateHeureLivraison() != null) {
                    existingCommande.setDateHeureLivraison(commande.getDateHeureLivraison());
                }
