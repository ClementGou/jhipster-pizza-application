...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('pizzaMarioApplicationApp.client.home.title');
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('pizzaMarioApplicationApp.client.home.createOrEditLabel');
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([
      ...
      clientUpdatePage.setNumeroTelephoneInput('numeroTelephone'),
      clientUpdatePage.setEmailInput('email'),
      clientUpdatePage.pizzaSelectLastOption(),
    ]);
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('pizzaMarioApplicationApp.client.delete.question');
