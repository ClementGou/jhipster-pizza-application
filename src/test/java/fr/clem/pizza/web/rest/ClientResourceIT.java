...
import fr.clem.pizza.domain.Client;
import fr.clem.pizza.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().nom(DEFAULT_NOM).numeroTelephone(DEFAULT_NUMERO_TELEPHONE).email(DEFAULT_EMAIL);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().nom(UPDATED_NOM).numeroTelephone(UPDATED_NUMERO_TELEPHONE).email(UPDATED_EMAIL);
        return client;
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.nom(UPDATED_NOM).numeroTelephone(UPDATED_NUMERO_TELEPHONE).email(UPDATED_EMAIL);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nom(UPDATED_NOM).numeroTelephone(UPDATED_NUMERO_TELEPHONE).email(UPDATED_EMAIL);
