...
import fr.clem.pizza.domain.Ingredient;
import fr.clem.pizza.repository.IngredientRepository;
...
class IngredientResourceIT {
    ...
    public static Ingredient createEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().nom(DEFAULT_NOM).quantite(DEFAULT_QUANTITE).prix(DEFAULT_PRIX);
        return ingredient;
    }
    ...
    public static Ingredient createUpdatedEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().nom(UPDATED_NOM).quantite(UPDATED_QUANTITE).prix(UPDATED_PRIX);
        return ingredient;
    }
    ...
    void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getQuantite()).isEqualTo(DEFAULT_QUANTITE);
        assertThat(testIngredient.getPrix()).isEqualTo(DEFAULT_PRIX);
    }
    ...
    void putExistingIngredient() throws Exception {
        ...
        updatedIngredient.nom(UPDATED_NOM).quantite(UPDATED_QUANTITE).prix(UPDATED_PRIX);
        ...
        assertThat(testIngredient.getQuantite()).isEqualTo(UPDATED_QUANTITE);
        assertThat(testIngredient.getPrix()).isEqualTo(UPDATED_PRIX);
    }
    ...
    void partialUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.nom(UPDATED_NOM).quantite(UPDATED_QUANTITE).prix(UPDATED_PRIX);
