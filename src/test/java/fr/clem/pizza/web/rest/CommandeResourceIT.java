...
import fr.clem.pizza.repository.CommandeRepository;
...
class CommandeResourceIT {
    ...
    private static final Boolean DEFAULT_EST_A_EMPORTER = false;
    private static final Boolean UPDATED_EST_A_EMPORTER = true;
    ...
    private static final Instant DEFAULT_DATE_HEURE_LIVRAISON = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_HEURE_LIVRAISON = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande()
            .estAEmporter(DEFAULT_EST_A_EMPORTER)
            .dateHeureCreation(DEFAULT_DATE_HEURE_CREATION)
            .dateHeureLivraison(DEFAULT_DATE_HEURE_LIVRAISON);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande()
            .estAEmporter(UPDATED_EST_A_EMPORTER)
            .dateHeureCreation(UPDATED_DATE_HEURE_CREATION)
            .dateHeureLivraison(UPDATED_DATE_HEURE_LIVRAISON);
        return commande;
    }
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getEstAEmporter()).isEqualTo(DEFAULT_EST_A_EMPORTER);
        assertThat(testCommande.getDateHeureCreation()).isEqualTo(DEFAULT_DATE_HEURE_CREATION);
        assertThat(testCommande.getDateHeureLivraison()).isEqualTo(DEFAULT_DATE_HEURE_LIVRAISON);
    }
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].estAEmporter").value(hasItem(DEFAULT_EST_A_EMPORTER.booleanValue())))
            .andExpect(jsonPath("$.[*].dateHeureCreation").value(hasItem(DEFAULT_DATE_HEURE_CREATION.toString())))
            .andExpect(jsonPath("$.[*].dateHeureLivraison").value(hasItem(DEFAULT_DATE_HEURE_LIVRAISON.toString())));
    }
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.estAEmporter").value(DEFAULT_EST_A_EMPORTER.booleanValue()))
            .andExpect(jsonPath("$.dateHeureCreation").value(DEFAULT_DATE_HEURE_CREATION.toString()))
            .andExpect(jsonPath("$.dateHeureLivraison").value(DEFAULT_DATE_HEURE_LIVRAISON.toString()));
    }
    ...
    void putExistingCommande() throws Exception {
        ...
        Commande testCommande = commandeList.get(commandeList.size() - 1);
        assertThat(testCommande.getEstAEmporter()).isEqualTo(UPDATED_EST_A_EMPORTER);
        assertThat(testCommande.getDateHeureCreation()).isEqualTo(UPDATED_DATE_HEURE_CREATION);
        assertThat(testCommande.getDateHeureLivraison()).isEqualTo(UPDATED_DATE_HEURE_LIVRAISON);
    }
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.estAEmporter(UPDATED_EST_A_EMPORTER);
